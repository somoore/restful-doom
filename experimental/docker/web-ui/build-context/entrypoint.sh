...
<body>
  <div class="container">
    ...
    <div class="port-info">
      <h2>API Endpoints</h2>
      <p>API Base URL: <span class="port-number">http://localhost:$DOOM_API_PORT</span></p>
      <p>Available Endpoints:</p>
      <ul>
        <li><a href="http://localhost:$DOOM_API_PORT/api/player" target="_blank">Player Information</a></li>
        <li><a href="http://localhost:$DOOM_API_PORT/api/world/objects" target="_blank">World Objects</a></li>
        <li><a href="http://localhost:$DOOM_API_PORT/api/things" target="_blank">Things (alias for world/objects)</a></li>
        <li><a href="http://localhost:$DOOM_API_PORT/docs.html" target="_blank">API Documentation</a></li>
      </ul>
      ...
      <h2>VNC Access</h2>
      <p>Direct VNC: <span class="port-number">localhost:$VNC_PORT</span> (password: password)</p>
      <p>Web VNC: <a href="http://localhost:$NOVNC_PORT/vnc.html?autoconnect=true&view_only=0" target="_blank" class="button">Launch Web VNC</a></p>
    </div>
